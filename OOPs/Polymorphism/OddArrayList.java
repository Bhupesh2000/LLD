...
// An array list class which will have only odd numbers
// Overriding functions like add() of ArratList as per our requirement
...
public class OddArrayList extends ArrayList<Integer> {
    ...
    public boolean addAll(int index, Collection< ? extends Integer> c){
        return super.addAll(index, c.stream().filter(OddArrayList::isOdd).collect(Collectors.toList())); // Using java stream and java collecttion
    }
